...
LICENSE.txt               # Proprietary source-code notice
```
...
Copyright © 2026 Mihai-Cristian Condrea. All rights reserved.

The original source code in this repository is proprietary and is not distributed under an open-source license. See [LICENSE.txt](LICENSE.txt) for the repository terms. Third-party software and other externally licensed materials remain subject to their respective licenses.
