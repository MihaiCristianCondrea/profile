...
export const COMMITTERS_RANKING_URL = 'https://committers.top/rank_only/romania.json';
export const COMMITTERS_USERNAME = 'MihaiCristianCondrea';
export const COMMITTERS_UPDATED_FALLBACK = 'Last updated: —';
...
export function formatDataAsOf(rawValue) {
...
export function updateCommittersStatus(statusElement, message, isError = false) {
  if (!statusElement) {
    return;
  }
...
export async function fetchCommittersRanking() {
