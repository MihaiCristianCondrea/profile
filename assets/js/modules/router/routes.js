(function (global) {
  ...
  function sanitizeOpenGraph(openGraphConfig, route, description) {
    ...
    const imageAlt =
      typeof config.imageAlt === 'string' && config.imageAlt.trim()
  ...
  function sanitizeTwitter(twitterConfig, openGraph, description) {
    ...
    const card =
      typeof config.card === 'string' && config.card.trim()
        ? config.card.trim()
    ...
    const creator =
      typeof config.creator === 'string' && config.creator.trim()
        ? config.creator.trim()
        : DEFAULT_TWITTER_HANDLE;
  ...
  const defaultRoutes = [
    ...
    },
    {
      ...
      metadata: {
        description:
          "Review the website privacy policy for Mihai-Cristian Condrea's personal site covering analytics, local storage preferences, and data protection practices.",
        keywords: [
    ...
    },
    {
      ...
      metadata: {
        description:
          "Listen to Mihai-Cristian Condrea's original tracks and playlists, including ambient production, electronic experiments, and featured collaborations.",
        keywords: [
    ...
    },
    {
      ...
      metadata: {
        description:
          "Discover Mihai-Cristian Condrea's Android and web projects featuring Jetpack Compose demos, Material You UI patterns, and open-source utilities.",
        keywords: [
    ...
    },
    {
      ...
      metadata: {
        description:
          'Contact Mihai-Cristian Condrea to discuss Android development collaborations, UI design engagements, or support for open-source apps.',
        keywords: [
    ...
    },
    {
      ...
      metadata: {
        description:
          'Learn about Mihai-Cristian Condrea, a Bucharest-based Android developer crafting Jetpack Compose apps, Material Design systems, and community tutorials.',
        keywords: [
    ...
    },
    {
      ...
      metadata: {
        description:
          'Understand how Mihai-Cristian Condrea integrates advertising across Android apps, including consent flows, personalization controls, and GDPR compliance.',
        keywords: [
    ...
    },
    {
      ...
      metadata: {
        description:
          "Review software licenses and third-party acknowledgments for Mihai-Cristian Condrea's Android and web applications.",
        keywords: [
    ...
    },
    {
      ...
      metadata: {
        description:
          "Read the community code of conduct guiding respectful collaboration across Mihai-Cristian Condrea's projects and communication channels.",
        keywords: [
    ...
    },
    {
      ...
      metadata: {
        description:
          "Review the privacy policy for Mihai-Cristian Condrea's Android applications covering analytics, consent mode, advertising IDs, and crash reporting.",
        keywords: [
    ...
    },
    {
      ...
      metadata: {
        description:
          "Understand the terms of service governing Mihai-Cristian Condrea's Android apps, including licensing, in-app purchases, and user responsibilities.",
        keywords: [
    ...
    },
    {
      ...
      metadata: {
        description:
          "Use Mihai-Cristian Condrea's interactive resume builder to assemble, preview, and download a polished CV template for Android developers.",
        keywords: [
  ...
  if (global.ModuleRegistry && typeof global.ModuleRegistry.register === 'function') {
    global.ModuleRegistry.register('router.routes', routesApi, { alias: 'RouterRoutes' });
  }
