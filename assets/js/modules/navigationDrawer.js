...
if (!ModuleRegistry || typeof ModuleRegistry.register !== 'function') {
  throw new Error('Navigation drawer module requires ModuleRegistry.');
}
...
function initNavigationDrawer() {
  ...
  if (navDrawer) {
    navDrawer.addEventListener('navigation-drawer-changed', (event) => {
      const opened =
        event && event.detail && typeof event.detail.opened === 'boolean'
          ? event.detail.opened
          : navDrawer.opened;
...
function _initToggleSection(toggleButton, contentElement) {
  ...
  toggleButton.addEventListener('click', () => {
    ...
    if (
      ...
      androidAppsContent &&
      androidAppsContent.classList.contains('open')
    ) {
      ...
      aboutContent &&
      aboutContent.classList.contains('open')
    ) {
...
function __setStandardDrawerLayoutForTest(value) {
  isStandardDrawerLayout = Boolean(value);
}

function __getStandardDrawerLayoutForTest() {
  return isStandardDrawerLayout;
}

const NavigationDrawerModule = {
  initNavigationDrawer,
  openDrawer,
  closeDrawer,
  updateDrawerLayout,
  syncDrawerState,
  __setStandardDrawerLayoutForTest,
  __getStandardDrawerLayoutForTest
};

ModuleRegistry.register('navigationDrawer', NavigationDrawerModule, {
  alias: 'SiteNavigationDrawer'
});

if (globalScope && typeof globalScope === 'object') {
  globalScope.initNavigationDrawer = NavigationDrawerModule.initNavigationDrawer;
  globalScope.openDrawer = NavigationDrawerModule.openDrawer;
  globalScope.closeDrawer = NavigationDrawerModule.closeDrawer;
  globalScope.updateDrawerLayout = NavigationDrawerModule.updateDrawerLayout;
  globalScope.syncDrawerState = NavigationDrawerModule.syncDrawerState;
  globalScope.__setStandardDrawerLayoutForTest =
    NavigationDrawerModule.__setStandardDrawerLayoutForTest;
  globalScope.__getStandardDrawerLayoutForTest =
    NavigationDrawerModule.__getStandardDrawerLayoutForTest;
}

if (typeof module === 'object' && typeof module.exports === 'object') {
  module.exports = NavigationDrawerModule;
}
